...
CREATE TABLE `menu` (
  ...
  `menu_available` int DEFAULT NULL,
...
INSERT INTO `menu` VALUES (1,'Пицца_Маргарита',300,400,1,NULL),(2,'Пицца_Пепперони',250,500,1,NULL),(3,'Пицца_Легион_овощей',300,350,1,'вег.'),(4,'Купа_Трупа',200,200,2,'напиток');
